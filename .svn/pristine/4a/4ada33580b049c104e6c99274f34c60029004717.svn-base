...
<!-- 				<a href="<?php echo U('AuthManager/group_delete?method=deleteGroup&id='.$vo['id']);?>" class="confirm ajax-get">删除</a> -->
				<a href="<?php echo U('AuthManager/group_delete?id='.$vo['id']);?>" class="confirm ajax-get">删除</a>
                </td>
