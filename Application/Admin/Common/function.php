...
function array_unique_fb($array2D){
 ...
 foreach ($temp as $k => $v){
  ...
  //下面的索引根据自己的情况进行修改即可
  $temp2[$k]['class_id'] =$array[0]=='' ? '无数据' : $array[0];
  $temp2[$k]['student_no'] =$array[1];
  $temp2[$k]['username'] =$array[2];
  $temp2[$k]['sex'] = $array[3] == 1 ? '男' : '女';
  $temp2[$k]['user_id'] =$array[4];
  $temp2[$k]['class_hour_id'] =$array[5];
