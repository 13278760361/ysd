...
function zxd_hook($name,$tag,$params=array()){
    \Think\Hook::listen2($name,$tag,$params);

    // $addon   = new \Addons\EditorForAdmin\EditorForAdmin();
...
function get_class_name($id){
    return M('class_years')->where(array('id'=>$id))->getField('year_name');
}
