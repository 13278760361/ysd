...
<body>
    ...
    <form action="<?php echo U('Sign/add');?>" method="post" class="form-horizontal">
        ...
        <input type="text" name="user_id"/>
         ...
         <div class="form-item">
            ...
            <select name="subject_id" id="subject_id">
                ...
                <?php if(is_array($subjects)): $i = 0; $__LIST__ = $subjects;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["subject_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
       </div>
...
$(function(){
    ...
    $("#subject_id").change(function(){
           var subject_id = $(this).val();
            $.ajax({
             type: "POST",
             url: "<?php echo U('Sign/getClassHour');?>",
